# Historical project review: 2026-07-20

> Historical commentary on commit `4811f05` and an old worktree. It does not
> describe current release state. Start at the [documentation home](../../README.md).
