# Historical flash-day record: 2026-07-01

> Historical record. It references an earlier ROM and boot image. Do not use it
> as current recovery guidance. Start at the [install and recovery guide](../guides/install-and-recovery.md).
